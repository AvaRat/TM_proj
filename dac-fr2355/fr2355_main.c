...
/*
  ...
  //send_12bit_via_uart(test_date.hour);
...
#endif
{
  switch(__even_in_range(SAC0IV,SACIV_4))
  {
    ...
    case SACIV_4:
        ...
        //SAC0DAT = sine_tab[i] & 0xFFF;//DAC_data;                 // DAC12 output positive ramp
        //DAC_data &= 0xFFF;
        //SAC0DAT = DAC_data;
        //P1OUT ^= BIT0;
        //UCA0TXBUF = 'a';
        ...
        //if (if_sendable == 1) {
            //if_sendable = 0;
        //    send_12bit_via_uart(sine_tab[sine_counter]);
        //sine_counter++;
       // if (sine_counter == NUMBER_OF_SINE_POINTS - 1)
        //    sine_counter = 0;
...
#endif
{
...

  {
    ...
    case USCI_UART_UCTXIFG:               // zwolnienie bufora
        ...
        //if (if_to_receive_next_UCTXI == 0)  // mozna chyba wylaczyc to przerwanie, ale na razie tak
        //    break;
