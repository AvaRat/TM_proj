...
void save_params(struct params_struct * params_struct_ptr) {
    ...
    tmp_fram_struct.if_used_before_reset = params_struct_ptr -> if_used_before_reset;
    ...
    tmp_fram_struct.day_of_week = params_struct_ptr -> day_of_week;
    tmp_fram_struct.hour = params_struct_ptr -> hour;
    tmp_fram_struct.minute = params_struct_ptr -> minute;
...
void get_params(struct params_struct * params_struct_ptr) {
    ...
    params_struct_ptr -> if_used_before_reset = tmp_fram_struct.if_used_before_reset;
    ...
    params_struct_ptr -> day_of_week = tmp_fram_struct.day_of_week;
    params_struct_ptr -> hour = tmp_fram_struct.hour;
    params_struct_ptr -> minute = tmp_fram_struct.minute;
}
